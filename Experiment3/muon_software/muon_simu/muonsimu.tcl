...
button .f2.1.1.fitting -width 20 -text "Fit" -state disabled -command { passverify ; .f2.1.1.fitting config -state normal }  -font $Font2
...
proc passverify { } {
    global Font1
    catch { destroy .passwd }
    toplevel .passwd
    focus -force .passwd
    wm title .passwd "Fitting"
    labelframe .passwd.fm -text "passwd verify" -padx 2 -pady 2 -font $Font1
    pack .passwd.fm
    entry .passwd.fm.ent -validate key -show "*" -textvariable passwd 
    pack .passwd.fm.ent -side top -padx 2 -pady 2 
    button .passwd.fm.submit -text submit -command {
    ...
    button .passwd.fm.cancel -text cancel -command { catch { destroy .passwd } }
    pack .passwd.fm.submit .passwd.fm.cancel -side left -fill both -padx 2 -pady 2 

    bind .passwd.fm.ent <Return> {
